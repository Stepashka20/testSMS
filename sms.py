...
print('''
 ...
 на Windows / linux - Ctrl+Z


 ''')
phone = input('Номер Телефона: +7')
countT = int(input('Количество Потоков: '))
phone1 = '7' + str(phone)
phone2 = '+7' + str(phone)
def infinity():
 while True:
	...
	while True:
		...
		if rMV.status_code == 200:
 			 print('Сообщение от сервиса №1 отправлено!')
    			...
    			print('Сообщение не отправлено - ошибка!')
while currT<=countT:
	t = Thread(target=mv)
	t.start()
	currT+=1
